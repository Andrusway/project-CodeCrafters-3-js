import{S as q,N as T,P as j,K,i as N,A as W,a as g}from"./assets/vendor-Dz2U2Gzw.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const u of i.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&a(u)}).observe(document,{childList:!0,subtree:!0});function n(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(o){if(o.ep)return;o.ep=!0;const i=n(o);fetch(o.href,i)}})();new q(".events-swiper",{modules:[T,j],slidesPerView:1,spaceBetween:16,autoHeight:!0,pagination:{el:".events-swiper-dots"},navigation:{nextEl:".events-btn-next",prevEl:".events-btn-prev"},breakpoints:{768:{slidesPerView:2,spaceBetween:24},1440:{slidesPerView:3,spaceBetween:24}}});function _(){const e=new q(".swiper-hero",{modules:[T,K],slidesPerView:1,loop:!1,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev",disabledClass:"swiper-button-disabled"},keyboard:{enabled:!0,onlyInViewport:!0},breakpoints:{0:{spaceBetween:16},768:{spaceBetween:32},1440:{spaceBetween:64}}});function t(){const n=document.querySelector(".swiper-button-prev"),a=document.querySelector(".swiper-button-next");n&&(n.disabled=e.isBeginning),a&&(a.disabled=e.isEnd)}return e.on("init",t),e.on("slideChange",t),e}const h=document.body,m=document.querySelector(".navbar-btn"),y=document.querySelector(".navbar-close-btn"),d=document.querySelector("ul.navbar"),I=window.matchMedia("(max-width:767px)"),c={backdrop:document.querySelector(".backdrop"),get bookModalContent(){return document.querySelector(".book-modal-content")},get bookModalCountInput(){return document.querySelector(".book-count")},booksList:document.querySelector(".books-list")};function A(){h.classList.toggle("no-scroll")}function P(e){e.matches?d.addEventListener("click",M):d.removeEventListener("click",M)}function M(e){te(e)}function z(e){return e.toLowerCase().replace(/\b\w/g,t=>t.toUpperCase())}function F(e){N.info({position:"topRight",message:e})}function Q(e){N.success({position:"topRight",message:e})}function f(){return Number(c.bookModalCountInput.value)}function Y(){c.backdrop.classList.add("is-open"),h.classList.add("no-scroll"),document.addEventListener("keydown",D)}function k(){c.backdrop.classList.remove("is-open"),h.classList.remove("no-scroll"),document.removeEventListener("keydown",D)}function G(e){const t=z(e.title);c.bookModalContent.innerHTML=`
      <img
  ...
  `,new W(".book-accordion-container",{showMultiple:!0})}const J="https://books-backend.p.goit.global/";function X(e){return`${J}books/${e}`}async function Z(e){try{return(await g.get(X(e))).data}catch(t){console.log(t)}}function ee(){if(!d.classList.contains("is-visible")){d.classList.add("is-visible"),m.classList.remove("is-visible"),y.classList.toggle("is-visible"),A();return}}function O(){if(d.classList.contains("is-visible")){d.classList.remove("is-visible"),m.classList.add("is-visible"),y.classList.toggle("is-visible"),A();return}}function te(e){const t=e.target.closest("a");if(!t)return;const n=t.getAttribute("href").substring(1),a=document.getElementById(n);a&&a.scrollIntoView({behavior:"smooth"}),O()}function D(e){e.key==="Escape"&&k()}async function oe(e){if(!e.target.closest(".books-learn-more-button"))return;const n=e.target.closest(".books-item").dataset.id;Y(),G(await Z(n))}function ne(e){e.target===e.currentTarget&&k()}function se(){k()}function ie(){c.bookModalCountInput.value=f()+1}function ae(){f()>1&&(c.bookModalCountInput.value=f()-1)}function re(){let e=f();const t=e>1?`В кошик додано ${e} книг`:"В кошик додана 1 книга";k(),F(t)}function ce(e){e.preventDefault(),k(),Q("Дякуємо за покупку")}function le(e){let t=Number(e.target.value);t<1&&(e.target.value=1),t>99&&(e.target.value=99)}g.defaults.baseURL="https://books-backend.p.goit.global/books/";const v=document.querySelector(".books-categories-list");async function de(){return(await g.get("category-list")).data}function ue(e){const t=e.map(({list_name:n})=>{if(n!=="")return`<li class="books-categories-item">${n}</li>`}).join("");v.innerHTML=t}async function be(){try{const e=await de();e.unshift({list_name:"All categories"}),ue(e)}catch(e){console.log(e)}}be();const pe=document.querySelector(".books-categories-title-wrapper");pe.addEventListener("click",H);function H(){v.classList.toggle("show-books-categories-list")}const w=document.querySelector(".books-show-more-button");function L(){w.classList.add("books-show-more-button-display")}function B(){w.classList.remove("books-show-more-button-display")}const b=document.querySelector(".books-list"),l=window.innerWidth>=768?24:10,S=document.querySelector(".books-number-info");let r=0,p=0;const E=4,U=0;let s=[];async function ge(){return(await g.get("top-books")).data.flatMap(a=>a.books)}async function ke(e){return(await g.get(`category?category=${e}`)).data}function C(e){return e.map(({author:n,book_image:a,price:o,title:i,_id:u})=>`<li class="books-item" data-id="${u}">
        ...
        </li>`).join("")}v.addEventListener("click",fe);async function fe(e){H();const t=e.target.textContent;t==="All categories"?V():he(t)}async function V(){B();try{s=await ge();const t=s.slice(U,l);b.innerHTML=C(t),r=s.length>l?l:s.length,p=s.length,S.textContent=`Showing ${r} of ${p}`,s.length>l&&L()}catch(e){console.log(e)}}V();async function he(e){B();try{const t=await ke(e);if(s=t,r=s.length>l?l:s.length,p=s.length,S.textContent=`Showing ${r} of ${p}`,!t.length){b.innerHTML="<p>Sorry, there are no books in this category!</p>";return}const n=s.slice(U,l);b.innerHTML=C(n),s.length>l&&L()}catch(t){console.log(t)}}w.addEventListener("click",me);let $=0,x=0;function me(){B(),$=r,r=s.length>r+E?r+E:s.length,S.textContent=`Showing ${r} of ${p}`,x=r;const e=s.slice($,x);b.insertAdjacentHTML("beforeend",C(e)),s.length>r&&L()}b.addEventListener("click",ye);function ye(e){if(e.target.nodeName!=="BUTTON")return;e.target.closest("li.books-item").dataset.id}function R(){document.querySelector(".swiper-hero")?_():setTimeout(R,50)}document.addEventListener("DOMContentLoaded",R);P(I);I.addEventListener("change",P);m.addEventListener("click",ee);y.addEventListener("click",O);c.booksList.addEventListener("click",oe);c.backdrop.addEventListener("click",e=>{e.target.closest(".modal-close-btn")&&se(),e.target.closest(".backdrop")&&ne(e),e.target.closest(".book-modal-btn-plus")&&ie(),e.target.closest(".book-modal-btn-minus")&&ae(),e.target.closest(".book-modal-add-btn")&&re(),e.target.closest(".book-modal-buy-btn")&&ce(e)});c.backdrop.addEventListener("input",e=>{e.target.closest(".book-count")&&le(e)});
