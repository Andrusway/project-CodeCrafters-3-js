import{S as q,N as T,P as j,K,i as N,A as W,a as g}from"./assets/vendor-D4Cj5E_D.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const u of i.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&a(u)}).observe(document,{childList:!0,subtree:!0});function n(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(t){if(t.ep)return;t.ep=!0;const i=n(t);fetch(t.href,i)}})();new q(".events-swiper",{modules:[T,j],slidesPerView:1,spaceBetween:16,autoHeight:!0,pagination:{el:".events-swiper-dots"},navigation:{nextEl:".events-btn-next",prevEl:".events-btn-prev"},breakpoints:{768:{slidesPerView:2,spaceBetween:24},1440:{slidesPerView:3,spaceBetween:24}}});function _(){const e=new q(".swiper-hero",{modules:[T,K],slidesPerView:1,loop:!1,navigation:{nextEl:".hero-swiper-button-next",prevEl:".hero-swiper-button-prev",disabledClass:"hero-swiper-button-disabled"},keyboard:{enabled:!0,onlyInViewport:!0},breakpoints:{0:{spaceBetween:16},768:{spaceBetween:32},1440:{spaceBetween:64}}});function o(){const n=document.querySelector(".hero-swiper-button-prev"),a=document.querySelector(".hero-swiper-button-next");n&&(n.disabled=e.isBeginning),a&&(a.disabled=e.isEnd)}return e.on("init",o),e.on("slideChange",o),e}const f=document.body,m=document.querySelector(".navbar-btn"),y=document.querySelector(".navbar-close-btn"),d=document.querySelector("ul.navbar"),I=window.matchMedia("(max-width:767px)"),c={backdrop:document.querySelector(".backdrop"),get bookModalContent(){return document.querySelector(".book-modal-content")},get bookModalCountInput(){return document.querySelector(".book-count")},booksList:document.querySelector(".books-list")};function A(){f.classList.toggle("no-scroll")}function P(e){e.matches?d.addEventListener("click",M):d.removeEventListener("click",M)}function M(e){oe(e)}function z(e){return e.toLowerCase().replace(/\b\w/g,o=>o.toUpperCase())}function F(e){N.info({position:"topRight",message:e})}function Q(e){N.success({position:"topRight",message:e})}function h(){return Number(c.bookModalCountInput.value)}function Y(){c.backdrop.classList.add("is-open"),f.classList.add("no-scroll"),document.addEventListener("keydown",D)}function k(){c.backdrop.classList.remove("is-open"),f.classList.remove("no-scroll"),document.removeEventListener("keydown",D)}function G(e){const o=z(e.title);c.bookModalContent.innerHTML=`
      <img
